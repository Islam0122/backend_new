    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(help_text='Введите текст сказки, который хотите добавить.', verbose_name='Текст сказки')),
                ...
                ('user', models.ForeignKey(help_text='Пользователь, создавший сказку.', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
                'verbose_name': 'Сказка',
